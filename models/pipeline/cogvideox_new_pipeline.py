...
class CogVideoXPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    ...
    def tensor_to_vae_latent(self, video_tensor):
        # video_tensor = video_tensor.unsqueeze(0)  # shape: [1, channels, frames, H, W]
        # batch_size, num_channels, num_frames, height, width = video_tensor.shape
        ...
        # print("patch_size_t:", patch_size_t, "latent_frames:", latent_frames, "video_tensor.shape:", video_tensor.shape, "self.vae_scale_factor_temporal:", self.vae_scale_factor_temporal)
        ...
        video = video_tensor.permute(0, 2, 1, 3, 4) # [frames, channels, H, W]
